...
public class MyAccountsTest extends Utility
{
    ...
    public void verifyThatUserRegisterAccountSuccessfully()
    {
        ...
        driver.findElement(By.xpath("//input[@id='input-firstname']")).sendKeys("Vicky");

        //3.4 Enter Last Name
        driver.findElement(By.xpath("//input[@id='input-lastname']")).sendKeys("Shah");

        //3.5 Enter Email
        driver.findElement(By.xpath("//input[@id='input-email']")).sendKeys("vicky.shah79285@yahoo.com");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully()
    {
        ...
        driver.findElement(By.xpath("//input[@id='input-email']")).sendKeys("vicky.shah7928@yahoo.com");
