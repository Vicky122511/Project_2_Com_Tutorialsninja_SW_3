...
public class LaptopsAndNotebooksTest extends Utility
{
    ...
    public void  verifyThatUserPlaceOrderSuccessfully()
    {
        ...
        driver.findElement(By.xpath("//input[@id='input-payment-firstname']")).sendKeys("Vicky");
        driver.findElement(By.xpath("//input[@id='input-payment-lastname']")).sendKeys("Shah");
        driver.findElement(By.xpath("//input[@id='input-payment-email']")).sendKeys("vicky.shah2928@yahoo.com");
        driver.findElement(By.xpath("//input[@id='input-payment-telephone']")).sendKeys("0123456789");
        driver.findElement(By.xpath("//input[@id='input-payment-address-1']")).sendKeys("26, mayfair road");
        driver.findElement(By.xpath("//input[@id='input-payment-city']")).sendKeys("Anand");
        driver.findElement(By.xpath("//input[@id='input-payment-postcode']")).sendKeys("388330");
